...
class MainActivity2Nivel4 : AppCompatActivity() {
    var score = 0
...
// i have added toast
    ...
    fun numAleAtorio() {
        ...
        if (score <= 39) {
            ...
            val intent = Intent(this, MainActivity2Nivel5::class.java)
